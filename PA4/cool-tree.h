...
public:
   ...
   virtual void add_method(Symbol class_name, Class_ class_ins) = 0;
   virtual void add_attr(Symbol class_name, Class_ class_ins) = 0;
   virtual bool is_method() = 0;
   virtual Symbol get_name() = 0;
   virtual void check_feature(Symbol class_name) = 0;
...
public:
   ...
   virtual Symbol check_expr(Symbol class_name) = 0;
   //virtual Symbol check_expr() = 0;
...
public:
   ...
   virtual Symbol check_branch(Symbol class_name) = 0;
...
public:
   ...
   void dump(ostream& stream, int n);
   void add_method(Symbol class_name, Class_ class_ins);
   void add_attr(Symbol class_name, Class_ class_ins);

   Symbol get_name() { return name; }
   Formals get_formals() { return formals; }
   Symbol return_method_type() { return return_type; }
   Expression return_expr() { return expr; }

   bool is_method() { return true; }
   void check_feature(Symbol class_name);
...
public:
   ...
   void dump(ostream& stream, int n);
   Symbol get_type_decl() { return type_decl; }
   Symbol check_branch(Symbol class_name);
...
public:
   ...
   void dump(ostream& stream, int n);
   Symbol check_expr(Symbol class_name);
